...
export function FoundersNote() {
  ...
  return (
    ...
    >
      ...
      <motion.figure
        className="founders-card m-0 mx-auto flex max-w-[760px] flex-col items-center rounded-[10px] border border-gray-100 bg-white px-[clamp(24px,5vw,64px)] pt-[clamp(36px,5vw,64px)] pb-[clamp(28px,4vw,52px)] text-center shadow-[0_18px_48px_-28px_rgba(0,0,0,0.25)]"
